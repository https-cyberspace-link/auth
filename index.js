...
export function getCustomToken(name) { return Cookies.get(name)}
export function setCustomToken(name, token) { Cookies.set(name, token) }
export function removeCustomToken(name) { Cookies.remove(name) }
